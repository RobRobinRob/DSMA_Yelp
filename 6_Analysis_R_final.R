...
# ----
# Acquisition of weather data - instead of running, import yelp_data_weather.csv
if(0){
  #load data
...
yelp_data_weather=read.csv(file="files/yelp_data_weather.csv")
#load("yelp_data_weather.RData")

# Load own data
yelp_pb <- read.csv("files/dsma_df_merged.csv",header=TRUE, na.strings="NULL")

#Load attribute data
attributes <- read.csv("files/attributes_cleaned_2.csv", na.strings="NA", header=TRUE, sep=";")
summary(attributes)
...
#Write as csv
write.csv(yelp_merged, "files/yelp_merged_final.csv", row.names= FALSE)
###########


########### Data Cleaning ##################################################################

yelp_merged <- read.csv("files/yelp_merged_final.csv")
...
# Create sub df's csv.
write.csv(yelp_sub_total,"files/yelp_sub_total.csv")
write.csv(yelp_sub_physical,"files/yelp_sub_physical.csv")
write.csv(yelp_sub_characteristics,"files/yelp_sub_characteristics.csv")
write.csv(yelp_sub_content,"files/yelp_sub_content.csv")
write.csv(yelp_sub_exogenous,"files/yelp_sub_exogenous.csv")
...
for (file in df_names){
  ...
  yelp_file <- read.csv(paste("files/", file, ".csv", sep =""))
  ...
  write.csv(yelp_train, "files/yelp_train.csv",row.names= TRUE)
  write.csv(yelp_test, "files/yelp_test.csv",row.names= TRUE)
  ...
  train <- h2o.importFile("files/yelp_train.csv")
  test <- h2o.importFile("files/yelp_test.csv")
...
write.csv(final_df,"files/final_results_model_performance.csv")
write.csv(comparison_df, "files/comparison_auc_gini_lift_df.csv")
...
# Fix SVM bug
comparison_df[24,"yelp_sub_physical"] <- comparison_df[24,"yelp_sub_physical"] * (-1)
comparison_df[24,"yelp_sub_characteristics"] <- comparison_df[24,"yelp_sub_characteristics"] * (-1)
comparison_df[24,"yelp_sub_content"] <- comparison_df[24,"yelp_sub_content"] * (-1)
comparison_df[24,"yelp_sub_exogenous"] <- comparison_df[24,"yelp_sub_exogenous"] * (-1)
comparison_df[24,"yelp_sub_total"] <- comparison_df[24,"yelp_sub_total"] * (-1)
comparison_df[24,"yelp_tuned"] <- comparison_df[24,"yelp_tuned"] * (-1)
